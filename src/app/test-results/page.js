      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          <div>
            ...
            <h1 className={`text-3xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Test Results</h1>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div className={`rounded-lg p-4 ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow`}>
              ...
              <p className="text-2xl font-bold text-blue-500">{testResults.length}</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-3">
              <select
                ...
                className={`px-4 py-2 rounded-lg border focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${darkMode ? 'bg-gray-700 border-gray-600 text-white' : 'border-gray-300'}`}
              >
              ...
              <tbody>
                {sortedResults.map((result, index) => (
                  ...
                  >
                    ...
                    <td className={`p-4 ${darkMode ? 'text-blue-400' : 'text-blue-600'} font-mono`}>
        ...
        <div className="mt-8 text-center">
          <button
            onClick={() => router.push('/')}
            className={`flex items-center gap-2 mx-auto px-6 py-3 rounded-xl font-semibold transition-all shadow-lg ${
              darkMode 
